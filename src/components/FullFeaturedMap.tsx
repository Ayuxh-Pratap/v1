    ...
    <div className="rounded-2xl bg-neutral-900/70 ring-1 ring-white/10 p-5">
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-neutral-800/70 ring-1 ring-white/10 rounded-xl text-neutral-100 placeholder-neutral-400 focus:ring-2 focus:ring-emerald-400/50 focus:outline-none"
        />
      </div>
